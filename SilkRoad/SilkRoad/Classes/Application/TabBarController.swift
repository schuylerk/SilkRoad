...
class ESTabBarItemCustomColorContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        textColor = .gray
        highlightTextColor = UIColor(red: 0.922, green: 0.624, blue: 0.349, alpha: 1)
    }
...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.backgroundColor = UIColor(red: 0.922, green: 0.624, blue: 0.349, alpha: 1)//UIColor.init(red: 23/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
